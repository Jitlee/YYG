...
<div id="subNavTabs">
	<ul id="s_sysmgr" class="nav-sidebar hidden">
		<?php if(ROLE == 1): ?><li id="usrmgr">
			<a>管理员管理</a>
			<ul>
				<li id="usrlst"><a href="/index.php/Admin/Index/../User">管理员列表</a></li>
				<li id="addusr"><a href="/index.php/Admin/Index/../User/add">添加管理员</a></li>
				<li id="chagpwd"><a href="/index.php/Admin/Index/../User/change">修改密码</a></li>
			</ul>
		</li><?php endif; ?>
	</ul>
	<ul id="s_gdmgr" class="nav-sidebar hidden">
		<li id="msmgr">
			<a>秒杀商品管理</a>
			<ul>
				<li id="mslst"><a href="/index.php/Admin/Index/../Miaosha">秒杀商品列表</a></li>
				<li id="addms"><a href="/index.php/Admin/Index/..//Miaosha/add">添加秒杀商品</a></li>
			</ul>
		</li>
		<li id="cmgr">
			<a>分类管理</a>
			<ul>
				<li id="clist"><a href="/index.php/Admin/Index/../Category">商品分类列表</a></li>
				<li id="blist"><a href="/index.php/Admin/Index/../Brand">品牌管理</a></li>
				<li id="addb"><a href="/index.php/Admin/Index/../Brand/add">添加品牌</a></li>
			</ul>
		</li>
	</ul>
