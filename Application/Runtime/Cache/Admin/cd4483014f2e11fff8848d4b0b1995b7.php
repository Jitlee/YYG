...
<<<<<<< Updated upstream
  ...
  <?php $__FOR_START_27447__=$pageNum+1;$__FOR_END_27447__=$maxPageNum;for($i=$__FOR_START_27447__;$i < $__FOR_END_27447__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
=======
  	<?php if($pageNum > 1): $__FOR_START_584135887__=$minPageNum;$__FOR_END_584135887__=$pageNum;for($i=$__FOR_START_584135887__;$i < $__FOR_END_584135887__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
