...
$(function() {
	...
	<div class="main">
		<h1><?php echo ($title); ?></h1>
		 <div class="nav">
	<a type="button" href="<?php echo U('index','','');?>" class="btn btn-default navbar-btn">全部会员</a>
	<a type="button" href="<?php echo U('today','','');?>" class="btn btn-default navbar-btn">今日新增</a>
	<a type="button" href="<?php echo U('add','','');?>" class="btn btn-primary navbar-btn">添加会员</a>
</div>
...
<nav>
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_1038169268__=$minPageNum;$__FOR_END_1038169268__=$pageNum;for($i=$__FOR_START_1038169268__;$i < $__FOR_END_1038169268__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_462866031__=$pageNum+1;$__FOR_END_462866031__=$maxPageNum;for($i=$__FOR_START_462866031__;$i < $__FOR_END_462866031__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
