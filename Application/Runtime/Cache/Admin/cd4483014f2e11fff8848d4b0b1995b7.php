...
<nav>
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_6928__=$minPageNum;$__FOR_END_6928__=$pageNum;for($i=$__FOR_START_6928__;$i < $__FOR_END_6928__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_5641__=$pageNum+1;$__FOR_END_5641__=$maxPageNum;for($i=$__FOR_START_5641__;$i < $__FOR_END_5641__;$i+=1){ ?><li><a href="/index.php/Admin/Member/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
