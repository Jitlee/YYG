...
<nav>
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_392676795__=$minPageNum;$__FOR_END_392676795__=$pageNum;for($i=$__FOR_START_392676795__;$i < $__FOR_END_392676795__;$i+=1){ ?><li><a href="/index.php/Admin/Paimai/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_291203020__=$pageNum+1;$__FOR_END_291203020__=$maxPageNum;for($i=$__FOR_START_291203020__;$i < $__FOR_END_291203020__;$i+=1){ ?><li><a href="/index.php/Admin/Paimai/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
