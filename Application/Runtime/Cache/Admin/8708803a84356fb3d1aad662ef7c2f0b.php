...
<nav>
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_212905592__=$minPageNum;$__FOR_END_212905592__=$pageNum;for($i=$__FOR_START_212905592__;$i < $__FOR_END_212905592__;$i+=1){ ?><li><a href="/index.php/Admin/Miaosha/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_209823702__=$pageNum+1;$__FOR_END_209823702__=$maxPageNum;for($i=$__FOR_START_209823702__;$i < $__FOR_END_209823702__;$i+=1){ ?><li><a href="/index.php/Admin/Miaosha/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
