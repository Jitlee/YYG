...
<nav>
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_1718469242__=$minPageNum;$__FOR_END_1718469242__=$pageNum;for($i=$__FOR_START_1718469242__;$i < $__FOR_END_1718469242__;$i+=1){ ?><li><a href="/index.php/Admin/Miaosha/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_1100407451__=$pageNum+1;$__FOR_END_1100407451__=$maxPageNum;for($i=$__FOR_START_1100407451__;$i < $__FOR_END_1100407451__;$i+=1){ ?><li><a href="/index.php/Admin/Miaosha/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
