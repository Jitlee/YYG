...
<nav>
  <ul class="pagination">
  	...
  	<?php else: ?>
    <li>
      <a href="/index.php/Admin/Xiangou/index/<?php echo ($pageSize); ?>/<?php echo ($minPageNum-1); ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li><?php endif; ?>
    <?php $__FOR_START_1303850151__=$minPageNum;$__FOR_END_1303850151__=$pageNum;for($i=$__FOR_START_1303850151__;$i < $__FOR_END_1303850151__;$i+=1){ ?><li><a href="/index.php/Admin/Xiangou/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
    <?php $__FOR_START_1311860110__=$pageNum+1;$__FOR_END_1311860110__=$maxPageNum;for($i=$__FOR_START_1311860110__;$i < $__FOR_END_1311860110__;$i+=1){ ?><li><a href="/index.php/Admin/Xiangou/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
	<?php if($maxPageNum == $pageCount): ?><li class="disabled">
  	...
  	<?php else: ?>
    <li>
      <a href="/index.php/Admin/Xiangou/index/<?php echo ($pageSize); ?>/<?php echo ($maxPageNum); ?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li><?php endif; ?>
  </ul>
