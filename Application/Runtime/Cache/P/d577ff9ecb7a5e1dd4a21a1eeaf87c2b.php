...
<div class="login">
	<div class="login_top">
		<h1><a rel="nofollow" href="<?php echo U('Index/index', '', '');?>"><img  width="154" height="96" src="/Public/P/images/logo/logo.jpg"/></a></h1>
		<p><a rel="nofollow" href="<?php echo U('Index/index', '', '');?>" class="back_home">返回首页</a><a href="<?php echo U('Help/index', '', '');?>/1" target="_blank" class="help">帮助中心</a></p>
	</div>
	<div class="login_bg">
