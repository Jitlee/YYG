...
<div class="share_main">
  ...
  <ul class="pagination">
    ...
    <li class="disabled">
  	...
  	<?php if($pageNum > 1): $__FOR_START_382603224__=$minPageNum;$__FOR_END_382603224__=$pageNum;for($i=$__FOR_START_382603224__;$i < $__FOR_END_382603224__;$i+=1){ ?><li><a href="/index.php/P/Saidan/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:#008000"><?php echo ($i); ?></a></li><?php } endif; ?>
	<li class="active"><a><?php echo ($pageNum); ?></a></li>
  <?php $__FOR_START_1399628884__=$pageNum+1;$__FOR_END_1399628884__=$maxPageNum;for($i=$__FOR_START_1399628884__;$i < $__FOR_END_1399628884__;$i+=1){ ?><li><a href="/index.php/P/Saidan/index/<?php echo ($pageSize); ?>/<?php echo ($i); ?>" style="color:red"><?php echo ($i); ?></a></li><?php } ?>
