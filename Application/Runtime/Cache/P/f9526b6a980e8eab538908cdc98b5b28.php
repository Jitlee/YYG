...
<div style="position: relative;" class="w1190">
	<link rel="stylesheet" type="text/css" href="/Public/P/css/newbie.css"/>
<div class="GuideContent clearfix">
	<div class="GuideW">
		<div class="Guidehead">
			<p><img src="/Public/P/images/other/newbie/Guide_1.jpg" border="0" alt=""></p>
			<p><img src="/Public/P/images/other/newbie/Guide_2.jpg" border="0" alt=""></p>
		</div>
		<div class="Guidebor clearfix">
			<ul class="Guide-Explain clearfix">
				<li class="Explain-l ExplainA"><p>选择一款商品，点击“立即1元云购”</p><img src="/Public/P/images/other/newbie/Guide_3.jpg" border="0" alt=""></li>
				<li class="Explain-r Explainimg"><img src="/Public/P/images/other/newbie/Guide_4.jpg" border="0" alt=""></li>
			</ul>
			<div class="Guide-Separate">
				<img src="/Public/P/images/other/newbie/Guide_5.jpg" border="0" alt="">
			</div>
			<ul class="Guide-Explain clearfix">
				<li class="Explain-l Explainimg"><img src="/Public/P/images/other/newbie/Guide_6.jpg" border="0" alt=""></li>
				<li class="Explain-r ExplainB"><p>支付1元，购买1人次，获得1个“云购码”</p><img src="/Public/P/images/other/newbie/Guide_7.jpg" border="0" alt=""></li>
			</ul>
			<div class="Guide-Separate">
				<img src="/Public/P/images/other/newbie/Guide_5.jpg" border="0" alt="">
			</div>
			<ul class="Guide-Explain clearfix">
				<li class="Explain-l ExplainC"><p>当一件商品达到总参与人次，抽出1名商品获得者；</p><img src="/Public/P/images/other/newbie/Guide_8.jpg" border="0" alt=""></li>
				<li class="Explain-r Explainimg"><img src="/Public/P/images/other/newbie/Guide_9.jpg" border="0" alt=""></li>
			</ul>
			<div class="Guide-Separate">
				<img src="/Public/P/images/other/newbie/Guide_5.jpg" border="0" alt="">
			</div> 
			<div class="Rule clearfix">
				<h2><img src="/Public/P/images/other/newbie/Guide_10.jpg" border="0" alt=""></h2>
				<ul class="Rule-Exp">
			...
			<div class="Rule clearfix Rulemat">
				<h2><img src="/Public/P/images/other/newbie/Guide_11.jpg" border="0" alt=""></h2>
				<ul class="Rule-Exp">
			...
			<div class="Rule-button">
				<a href="<?php echo U('Index/index', '', '');?>" target="_self"><img src="/Public/P/images/other/newbie/Guide_14.jpg" border="0" alt=""></a>
			</div>
		</div>
