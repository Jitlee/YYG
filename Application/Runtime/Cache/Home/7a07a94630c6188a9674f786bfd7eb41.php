...
<html>
	...
	<div class="swiper-container swiper-loop">
	    <div class="swiper-wrapper">
	    		<?php if(is_array($images)): foreach($images as $key=>$image): ?><div class="swiper-slide"><img src="<?php echo ($image["image_url"]); ?>"></div><?php endforeach; endif; ?>
	    </div>
	</div>
	...
	<h5 class="yyg-view-margin">当前价：¥ <?php echo ($data["zuigaojia"]); ?></h5>
...
<footer class="yyg-footer">
	<div class="yyg-footer-left">
		...
		<div class="yyg-btn yyg-btn-primary">我要出价</div>
	</div>
</footer>
