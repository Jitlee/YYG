...
<ul class="mui-table-view yyg-margin20">
	<li class="mui-table-view-cell"><a class="mui-navigate-right">出价记录(<span id="chujiacishuLabel"><?php echo ($data["chujiacishu"]); ?></span>)</a></li>
...
<?php if(isset($isBaozheng)): ?><style>
	...
	<div id="chujiaBlock" class="yyg-chujia-bg" style="display: none;">
		...
		<input id="inputChujia" value="<?php echo ($zuidijia); ?>" />
		<div class="yyg-btn">+100</div>
		<div class="yyg-btn">+1000</div>
